...
export class AnimationHandler {
  ...
  public static add(scene: Phaser.Scene, avatar: AvatarKeys): void {
    ...
    scene.anims.create({
      ...
      frames: scene.anims.generateFrameNumbers(avatar, {
        start: getFrameNumber(19, 1),
        end: getFrameNumber(19, 11),
      }),
      frameRate: 40,
    });
    ...
    scene.anims.create({
      ...
      frames: scene.anims.generateFrameNumbers(avatar, {
        start: getFrameNumber(17, 1),
        end: getFrameNumber(17, 11),
      }),
      frameRate: 40,
    });
    ...
    scene.anims.create({
      ...
      frames: scene.anims.generateFrameNumbers(avatar, {
        start: getFrameNumber(20, 1),
        end: getFrameNumber(20, 11),
      }),
      frameRate: 40,
    });
