...
const createNpcAnims = (anims: Phaser.Animations.AnimationManager) => {
  ...
  anims.create({
    ...
    frames: anims.generateFrameNumbers(NpcKeys.COBRA, { start: getFrameNumber(1, 1), end: getFrameNumber(1, 3) }),
    frameRate: 10,
    repeat: -1
  })
  ...
  anims.create({
    ...
    frames: anims.generateFrameNumbers(NpcKeys.COBRA, { start: getFrameNumber(2, 1), end: getFrameNumber(2, 3) }),
    frameRate: 10,
    repeat: -1
  })
  ...
  anims.create({
    ...
    frames: anims.generateFrameNumbers(NpcKeys.COBRA, { start: getFrameNumber(3, 1), end: getFrameNumber(3, 3) }),
    frameRate: 10,
    repeat: -1,
  })
}
